...
public class RetrofitUtils implements INetWorkInterface {
    ...
    private RetrofitUtils(){
        ...
        Retrofit build1 = new Retrofit.Builder()
                ...
                .build();
        apiServices = build1.create(ApiServices.class);
    }
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            Type[] actualTypeArguments = ((ParameterizedType) interfaces[0]).getActualTypeArguments();
                            Type type = actualTypeArguments[0];
                            Gson gson = new Gson();
                            T fromJson = gson.fromJson(string, type);
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            Type actualTypeArgument = actualTypeArguments[0];
                            Gson gson = new Gson();
                            T fromJson = gson.fromJson(string, actualTypeArgument);
                            callBack.onSuccess(fromJson);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
